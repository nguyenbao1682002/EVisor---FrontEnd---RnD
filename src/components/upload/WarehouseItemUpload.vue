...
import { useUploadWarehouseItem } from "../../composables/Warehouse/useUploadWarehouseItem";

export default {
  name: "WarehouseItemUpload",
  props: {
    modelValue: {
      type: Boolean,
      default: false,
  ...
  setup(props, { emit }) {
    ...
    const { isUploading, uploadFile } = useUploadWarehouseItem();
