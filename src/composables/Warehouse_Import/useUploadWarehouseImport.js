...
import { uploadImportDataWarehouseApi } from "../../services/auth.service";

export function useUploadWarehouseImport() {
    ...
    const uploadFile = async (file) => {
        ...
        try {
            const response = await uploadImportDataWarehouseApi(payload, new AbortController().signal);
